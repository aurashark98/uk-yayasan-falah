...
$sql = "SELECT id, judul, deskripsi, tanggal, foto FROM berita";
        ...
        <div class="berita-list">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<img src='" . htmlspecialchars($row["foto"]) . "' alt='" . htmlspecialchars($row["judul"]) . "'>"; // Menampilkan foto
                    echo "<h3>" . htmlspecialchars($row["judul"]) . "</h3>";
                    echo "<p>" . htmlspecialchars($row["deskripsi"]) . "</p>";
                    echo "<p>Tanggal: " . date("d F Y", strtotime($row["tanggal"])) . "</p>";
                    echo "</div>";
                }
            } else {
